...
namespace HtmlAgilityPack
{
    ...
    public partial class HtmlDocument
    {
        ...
        private void CloseCurrentNode()
        {
            ...
            bool error = false;
            HtmlNode prev = HtmlUtilities.GetDictionaryValueOrNull(Lastnodes, _currentnode.Name);
        ...
        {
            HtmlNode resetter = HtmlUtilities.GetDictionaryValueOrNull(Lastnodes, _currentnode.Name);
            if (resetter == null)
                return null;
